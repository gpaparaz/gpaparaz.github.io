...
(function ($) {
	...
	var $footer = $('#footer');
	var htmlFooter = `<div class="inner">
	<ul class="icons">
		<li><a href="https://github.com/gpaparaz?tab=repositories" target="_blank" class="icon bi bi-github"
				style="font-size: 1.2em !important"><span class="label">Github</span></a></li>
